...
public class SmtpEmailNotifier {
    ...
    private static final String SMTP_USER = System.getProperty("mail.smtp.user", "coffeevan@example.com");
    private static final String SMTP_PASS = System.getProperty("mail.smtp.password", "");
    private static final String MAIL_TO   = System.getProperty("mail.to", "admin@example.com");
    ...
    public static void sendCriticalAlert(String subject, String body) {
        ...
        try {
            ...
            Object fromAddress = interAddressClass.getConstructor(String.class).newInstance(SMTP_USER);
            Object toAddress = interAddressClass.getConstructor(String.class).newInstance(MAIL_TO);
            ...
            logger.info("Critical alert email sent to {}", MAIL_TO);
        } catch (Exception e) {
